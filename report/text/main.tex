...
\begin{figure}[ht]
    ...
    \caption{Relative $L^2$ error on the test set after end-to-end fine-tuning.}
    \label{fig:laplacelatent}
\end{figure}

\subsubsection{Results}

% TODO: median L2rel before and after fine-tuning; comparison with Tucker POD and Laplace SVD.
...
\begin{table}[ht]
    ...
    \begin{tabular}{lccc}
        ...
        \midrule
        Tucker POD           & Linear POD coefficients        & ${\sim}$1\,M & --- \\
        Laplace SVD          & Per-frequency linear SVD       & ---           & --- \\
        Latent Laplace       & Shared non-linear latent code  & ---           & --- \\
        Latent Laplace + AEC & + UNet residual                & $+481$k       & --- \\
        \bottomrule
    \end{tabular}
    \caption{Comparison of transient surrogates on the test set.}
    \label{tab:comparison}
\end{table}

% TODO: fill in parameter counts, median L2rel, inference time.
