...
\begin{frame}{Future Work}
  \begin{itemize}
      \item \textbf{Regularization of the Laplace inversion} (rather than truncation + Unet).
      \item \textbf{Contour discussion:} A purely vertical or horizontal contour seems suboptimal.
  \end{itemize}
  \vspace{2em}
  \begin{center}
      \textbf{Thank you!}
